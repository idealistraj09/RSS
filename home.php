                ...
                <div class="main_book">
                    ...
                    <div class="main_content">
                        <form method="get" action="#">
                            <center><input type="text" require placeholder="Source" id="c"></center>
                            <button onclick="swap()"><img src="https://img.icons8.com/glyph-neue/50/000000/swap.png" height="30px" width="20px" /></button>
                            <center><input type="text" require placeholder="Destination" id="d"></center>
                            <input type="date" require>
                            <select name="class">
                                <option value="AC" default>AC</option>
